...
public class Pass2019MallorcaCalculatorController extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static Pass2019MallorcaCalculatorController instance = null;
    
    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the Pass2019MallorcaCalculatorController class 
     */
    public static Pass2019MallorcaCalculatorController getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new Pass2019MallorcaCalculatorController();
                }
            }
        }
        return instance;

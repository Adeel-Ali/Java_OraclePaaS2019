...
public class OracleCalculatorController extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static OracleCalculatorController instance = null;
    
    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the OracleCalculatorController class 
     */
    public static OracleCalculatorController getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new OracleCalculatorController();
                }
            }
        }
        return instance;

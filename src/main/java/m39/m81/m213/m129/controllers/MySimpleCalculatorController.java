...
public class MySimpleCalculatorController extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static MySimpleCalculatorController instance = null;
    
    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the MySimpleCalculatorController class 
     */
    public static MySimpleCalculatorController getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new MySimpleCalculatorController();
                }
            }
        }
        return instance;

...
public class OraclePaaSCalculatorController extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static OraclePaaSCalculatorController instance = null;
    
    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the OraclePaaSCalculatorController class 
     */
    public static OraclePaaSCalculatorController getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new OraclePaaSCalculatorController();
                }
            }
        }
        return instance;
